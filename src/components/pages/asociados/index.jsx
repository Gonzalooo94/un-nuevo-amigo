...
export default function Asociados() {
    ...
    const url ='https://proyectorefugioanimal.herokuapp.com/users'
  ...
  const navegate = useNavigate()    // direccionar paginas
    ...
    const handleDelete = async (id) => {
      axios.delete(`https://proyectorefugioanimal.herokuapp.com/users/${id}`)
        .then(() => {
          axios.get('https://proyectorefugioanimal.herokuapp.com/users')
            .then(res => {
              setTodos(res.data)
            })
        })
