...
export default function Mascotas() {
    ...
    const url ='https://proyectorefugioanimal.herokuapp.com/animals'
  ...
  useEffect(() => {
    ...
    const handleDelete = async (id) => {
      axios.delete(`https://proyectorefugioanimal.herokuapp.com/animals/${id}`)
        .then(() => {
          axios.get('https://proyectorefugioanimal.herokuapp.com/animals')
            .then(res => {
              setTodos(res.data)
            })
        })
